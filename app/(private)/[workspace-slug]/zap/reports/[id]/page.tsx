...
export const metadata: Metadata = {
  title: 'Relatório | WhatsApp | Steel',
  description: 'Construtor de relatórios do WhatsApp',
}

export default async function WhatsappReportBuilderPage({
  params,
}: {
