    ...
    <header className='relative z-10 mx-auto flex max-w-[1600px] items-center justify-between gap-6 px-6 py-6 sm:px-10 lg:px-[123px]'>
      ...
      {content.ctaLabel || !readOnly ? (
        <a
          ...
          data-cta
          className='inline-flex shrink-0 items-center justify-center rounded-lg bg-[#161c2d] px-6 py-4 font-bold text-[15px] text-white tracking-[-0.1px] transition-opacity hover:opacity-90'
        >
          <GhostInput
