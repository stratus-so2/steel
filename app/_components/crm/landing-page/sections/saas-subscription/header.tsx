...
export function SaasSubscriptionHeader({
  content,
  onChange,
  readOnly,
    ...
    <header className='relative z-10 mx-auto flex max-w-[1600px] items-center justify-between gap-6 bg-white px-6 py-6 sm:px-10 lg:px-[123px]'>
      ...
      {content.ctaLabel || !readOnly ? (
        <GhostLink
          ...
          readOnly={readOnly}
          data-cta
          className='inline-flex shrink-0 items-center justify-center rounded-lg bg-[#473bf0] px-6 py-3 font-bold text-[15px] text-white tracking-[-0.4px] transition-opacity hover:opacity-90'
        >
          <GhostInput
